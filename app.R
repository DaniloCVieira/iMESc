  ...
  output$ptree_control <- renderUI({
    column(
      ...
      splitLayout(
        ...
        numericInput("mincriterion", strong("mincriterion",tipify(icon("fas fa-question-circle"),"the value of the test statistic", options=list(container="body"))), 0.95),
        ...
        numericInput("nresample", strong("nresample",tipify(icon("fas fa-question-circle"),"number of MonteCarlo replications to use when the distribution of the test statistic is simulated.", options=list(container="body"))), 999, step = 1)
      ),
      splitLayout(
        numericInput("maxsurrogate", strong("maxsurrogate",tipify(icon("fas fa-question-circle"),"number of surrogate splits to evaluate. Note the currently only surrogate splits in ordered covariables are implemented.", options=list(container="body"))), 0, step = 1),
