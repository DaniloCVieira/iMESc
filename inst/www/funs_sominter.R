...
#' @export
get_somERR<-function(predsom_results=c('BMUs','Data predictions (X)','Neuron predictions (X)','Data predictions (Y)',"Neuron predictions (Y)","Obs errors (X)","Obs errors (Y)","Var errors (X)","Var errors (Y)","SOM quality"),m,newdata,newdataY,som_pred){
